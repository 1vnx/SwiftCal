...
export default function Features() {
  ...
  return (
    <div className="relative z-20 pb-10 px-10 lg:pb-40 max-w-7xl mx-auto">
      <div className="px-8">
      ...
      <div className="w-full  mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  relative">
          <Image
            ...
            width={800}
            height={800}
            className="h-full w-full aspect-square object-cover object-center rounded-sm opacity-80 group-hover/image:opacity-100 transition-all duration-200"
          />
        </div>
      </div>
    </Link>
